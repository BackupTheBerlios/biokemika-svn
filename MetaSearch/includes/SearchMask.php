 ...
 * class MsSearchMask
 *
 * The MsSearchMask class provides an interface to the input
 * form that is filled out by the user. By using this class,
 * you can set various parameters how the form should look
 * like. At the end you simply call print_out() and the actual
 * form will be appended to $wgOut.
 *
